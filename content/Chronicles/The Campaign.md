...
- [[Chronicles/Campaign Prep/Session 2 Memory Combat|Session 2 Memory Combat]]
...
- The Anchored did not realize the seawall would disrupt the Barrier, and are
  now trying to restore the anchor's alignment before the failure spreads
...
- These entities appear to be a separate threat, but are a byproduct of the
  same failure
- The [[Lore/The Barrier|Relief Chamber]] may be overflowing or backflowing as
  the Barrier receives corrupted timing from the coastal anchor
