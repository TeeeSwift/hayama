...
Zenji exists in an incomplete and unstable state.

He:
- was not meant to return
- is not properly integrated into the system
- is missing a core part of himself (his divinity)
...
- disoriented
- fragmented
- unable to recall details clearly

Over time:
- recognizes patterns before facts
- identifies places and situations that feel "wrong"
- gradually reconstructs his understanding of the world
...
- Zenji identifies patterns and anomalies
- Teru investigates them in the physical world
...
He does not initially understand what it is, only that:
...
Zenji does not seek to reclaim his former power.
