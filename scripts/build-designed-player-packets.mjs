...
const packets = [
  {
    ...
    context: {
      ...
      recent:
        "レストランと建物のオーナーである「Mollusk lady」は、ゆっくりした話し方の、夢見がちな、控えめなおばあさんです。Alexのアートをいつも辛抱強く応援してくれていて、ある時、かわいい真珠の飾りがついたブレスレットを贈ってくれました。その時の言葉は、Alexの中に残っています。「芸術家の責任は、人々に『彼ら対私たち』の中に『彼ら』なんていないと気づかせることだよ。」\n\n仕事の面では、AlexはVincentと何度か一緒に動いたことがあります。市の案件、公共・民間プロジェクト、改修、新築などでAlexがコンサルタントとして関わり、Vincentはより上の指揮系統から現場や調整を見ていました。深く付き合う間柄ではありませんが、お互いに顔と仕事ぶりを知っていて、会えば礼儀正しく話せる関係です。",
      npcs: [
        [
          "Mollusk lady",
          "レストランと建物のオーナー。ゆっくり、夢見がち、控えめで、Alexの芸術を温かく支えてくれる。真珠のブレスレットを贈ってくれた。",
        ],
        [
          "Vincent",
      ...
      roleplay: [
        ...
        "真珠のブレスレットは、優しさ、責任、境界を越える表現を思い出させる。",
      ],
      questions: [
        "これは集中が必要な呪文ですか？",
  ...
  },
  {
    ...
    classSections: [
      ...
      },
      {
        title: "武器マスタリー",
        body: [
          "Shortsword と Handaxe にマスタリーがあります。命中した時にシートのマスタリー効果を確認し、使えそうならDMに聞いてください。",
        ],
      },
    ],
    combat: [
  ...
  },
  {
    ...
    context: {
      ...
      npcs: [
        ...
        ["Ryunnu", "ダイビング教室に参加していた新参者。異変を別の角度から見ているかもしれない。"],
      ],
  ...
  },
  {
    ...
    role: "記録と契約魔術",
    roleText: "記録のズレを拾い、少ない呪文を重要な瞬間に使う。",
    stats: [
      ["最大HP", "8"],
      ["PB", "+2"],
      ["呪文DC", "11"],
    ...
    classIntro:
      "Ryunnuは「システムのズレに気づく」ウォーロックです。人が感情や噂として感じる異変を、記録、時刻、電力、同期、認証、機械の挙動として見ることができます。戦闘では Eldritch Blast を基本にし、1つしかない呪文スロットを重要な場面に使います。",
    classSections: [
      {
        title: "システムを見る",
        body: [
          "電気、設備、記録、アプリ、POS、監視カメラ、タイムスタンプに注目します。人間の記憶と機械の記録が食い違う時、強い手がかりを得られるかもしれません。",
        ],
      },
      {
        title: "Pact Magic",
    ...
    context: {
      ...
      recent:
        "町の人に、電気工事や設備修理を頼まれがちです。実際には施工担当ではないので、よく訂正しています。\n\nカフェや設備まわりで、普通の故障とは言い切れない挙動を見ました。人が気づかない相手や出来事を、機械だけが記録し続けるような不一致が起きるかもしれません。",
      npcs: [
        ...
        [
          "他のPCたち",
          "Ryunnuとは違う種類の違和感を拾っている。情報を合わせると見え方が変わるかもしれない。",
        ],
      ],
      places: [
        "Nagisabashi Coffee",
    ...
    appendix: [
      ...
      },
      {
        ...
        note: "Fathomless patronを使う場合の1レベル拡張呪文です。シートのルール年版に合わせて確認してください。",
        rows: [
          [
...
function warlockInvocationRows() {
  return [
    ["Armor of Shadows", "", "Mage Armorをスロットなしで自分に使える。防御を常に上げたい時。"],
    ["Eldritch Mind", "", "集中維持の耐久力セーヴに有利。Hex等を切らしたくない時。"],
    ["Pact of the Blade", "", "魔法の武器を出す/結びつける。武器で戦うウォーロック向け。"],
    ["Pact of the Chain", "", "Find Familiarと特殊な使い魔。偵察、Help、安全な情報収集に強い。"],
    ["Pact of the Tome", "", "Book of Shadowsで追加の cantrip/儀式的な柔軟性。問題解決型。"],
  ]
}
