...
- Light instruction scene
- Players roleplay introductions
- Subtle weirdness:
  - Water temperature inconsistent
  - Gear pressure readings slightly off
  - A participant mentions hearing something underwater before even diving

## First Disturbance

During or just after entry into the water:

- Visibility drops suddenly
- Coral appears where it should not be
- A shape moves just beyond sight
...
- Everyone resurfaces safely, but unsettled
- Something is clearly off with the water
- Sets up further investigation
