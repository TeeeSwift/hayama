...
Barnacle is a seemingly ordinary Hayama caretaker and maintenance contractor who
appears around anomaly sites, old infrastructure, shrine edges, seawalls, and
locked access points.

In truth, Barnacle is one of [[Actors/The Anchored|The Anchored]]: a field
observer and living patch whose sacred function is to keep broken things attached
long enough for Hayama to survive.

They are less a spy than a maintenance worker of the supernatural system.

## Location

Barnacle is route-based rather than tied to a single home base.
...
Barnacle is known around Hayama as a local caretaker and maintenance contractor.
...
This lets Barnacle appear repeatedly without immediately seeming supernatural.

## Faction

- [[Actors/The Anchored|The Anchored]]

Barnacle is not necessarily a leader. They are a field-level observer,
containment agent, surveyor, or ritual technician hidden behind mundane
maintenance work.

Publicly, Barnacle may pass as:
...
Privately, Barnacle is monitoring the Barrier's failures and deciding what
evidence must be preserved, sealed, or removed.

## Narrative Function

Barnacle provides suspicion.

Use Barnacle when the story needs the players to ask:
...
- whether the Anchored caused the incident
- why old infrastructure matters
- whether containment and cover-up are different things
...
> Panic wastes time. Explanation wastes more.
...
Barnacle's divinity manifests through adhesion, calcification, surface-reading,
and temporary stabilization.

Possible expressions:

- barnacles appear briefly on objects they touch, then crumble into salt
- damaged concrete develops a pale shell-like crust where Barnacle seals it
- Barnacle's hands are rough like old shell, stone, or scraped seawall
- Barnacle can fasten a cracked marker, gate, pipe, or threshold shut for a short
  time
- Barnacle instinctively scrapes surfaces when thinking
- Barnacle can read stress in a wall or stone by touching the pattern of salt and
  shell growth
- small crescent scars remain on metal, wood, or concrete after their repairs
- reclaiming growth dies back where Barnacle applies pressure, making them look
  suppressive or poisonous to the sea

To the Tsunodas, Barnacle does not heal. They crust over the wound.

To the Anchored, Barnacle keeps the structure from splitting.

To the players, Barnacle should raise the question:

> Are they saving the town, or sealing something alive inside it?

## What Barnacle Provides The Story

### Suspicious Evidence Handling
...
- take notes in a script or shorthand tied to the Barrier
- appear at multiple incidents before the party connects them
...
Barnacle may obstruct the party by:

- withholding explanations
- taking evidence
- refusing to name the danger
- warning witnesses into silence
- blocking access to unstable sites

But Barnacle should not feel cruel. They should feel controlled, tired, and
deeply accustomed to not being believed.

## Methods

Barnacle's work can feel halfway between ritual and field engineering.

Possible methods:

- salt-thread grids
- old brass measuring tools
- folded paper seals
- tide charts annotated with impossible times
- listening rods pressed against stone
...
Barnacle may recognize Alex's name from project approval records and treat her as
...
Barnacle may perceive Marin as a destabilizing variable because of her displaced
divinity.
...
Barnacle sometimes uses Daimon access. This does not mean they are Suzuki-aligned.
It means Daimon has keys.

Old arrangements allow Barnacle into places that should be closed. Neither side
...
The Tsunoda Memory-Keeper likely dislikes Barnacle.

To the Tsunodas, Barnacle does not repair. They silence. They patch over wounds
without naming them.
